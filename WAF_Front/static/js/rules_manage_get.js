             ...
             $('#mytab').bootstrapTable({
                        //全部参数
                        url:"/get_data",                     //从后台获取数据时，可以是json数组，也可以是json对象
                        dataType: "json",
                        method: 'post',                      //请求方式（*）
                    ...
                    function change_status(index,status){
                        $.ajax({
                            type:'post',
                            dataType:'json',
                            url:"get_rules_manage/change_status_get",
                            data:{
                                id:index,
                                status:status
                            },
                ...
                function remove_rules(id){
                    $.ajax({
                        type:'post',
                        dataType:'json',
                        url:"/get_rules_manage/remove_rules_get",
                        data:{
                            id:id
                            },
                        success:function(data){
             ...
             //重置搜索条件
                ...
                $('#add_rules_form').submit(function(e){
                    ...
                    $.ajax({
                        url:'/get_rules_manage/add_rules_get',
                        type:'POST',
                        data:$(this).serialize(),
                        success:function(data){
                            flag=data['flag'];
