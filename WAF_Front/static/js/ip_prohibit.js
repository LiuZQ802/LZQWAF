             ...
             $('#mytab').bootstrapTable({
                        //全部参数
                        url:"/ip_data",                     //从后台获取数据时，可以是json数组，也可以是json对象
                        dataType: "json",
                        method: 'post',                      //请求方式（*）
                        ...
                        columns: [
                            ...
                            {
                                field: 'ip',  //返回数据rows数组中的每个字典的键名与此处的field值要保持一致
                                title: 'IP',
                                align: 'center',
                                valign: 'middle',
                            },
                    ...
                    function change_status(index,status){
                        $.ajax({
                            type:'post',
                            dataType:'json',
                            url:"ip_prohibit_manage/change_status_ip",
                            data:{
                                id:index,
                                status:status
                            },
                ...
                function remove_rules(id){
                    $.ajax({
                        type:'post',
                        dataType:'json',
                        url:"ip_prohibit_manage/remove_ip",
                        data:{
                            id:id
                            },
                        success:function(data){
