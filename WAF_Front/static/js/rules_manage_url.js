             ...
             $('#mytab').bootstrapTable({
                        //全部参数
                        url:"/url_data",                     //从后台获取数据时，可以是json数组，也可以是json对象
                        dataType: "json",
                        method: 'post',                      //请求方式（*）
                    ...
                    function change_status(index,status){
                        $.ajax({
                            type:'post',
                            dataType:'json',
                            url:"url_rules_manage/change_status_url",
                            data:{
                                id:index,
                                status:status
                            },
                            success:function(data){
                                ...
                                if(flag){
                                    ...
                                    a='<div class="alert alert-danger" id="alert_error" style="text-align:center;position:fixed;top:0px;left:500px;width:800px"><strong>失败!</strong> '+mess+'</div>';
                                    $('#haha').append(a);
                ...
                function remove_rules(id){
                    $.ajax({
                        type:'post',
                        dataType:'json',
                        url:"url_rules_manage/remove_rules_url",
                        data:{
                            id:id
                            },
                        success:function(data){
             ...
             //重置搜索条件
                ...
                $('#add_rules_form').submit(function(e){
                    ...
                    $.ajax({
                        url:'/url_rules_manage/add_rules_url',
                        type:'POST',
                        data:$(this).serialize(),
                        success:function(data){
                            flag=data['flag'];
